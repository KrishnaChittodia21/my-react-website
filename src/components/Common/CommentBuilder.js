...
const fields = [
  { name: 'content', elementName: 'input', type: 'text', placeholder: 'Write you comment'},
]
      ...
      <div>
        <form onSubmit={ e => {
          ...
          const comment = {
            ...
            profileId: this.props.auth.profile[0].id,
...
export default connect(
  ...
  validationSchema: yup.object().shape({
    content: yup.string().required('Your comment need to have text')
  })
})(CommentBuilder));